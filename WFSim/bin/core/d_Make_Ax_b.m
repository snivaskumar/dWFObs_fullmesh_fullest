function [sol, sys] = d_Make_Ax_b(Wp,sys,sol,options)
% Import variables
Nx    = Wp.mesh.Nx;
Ny    = Wp.mesh.Ny;
...
[StrucDiscretization]                = d_SpatialDiscr_Hybrid(Wp,sol,options.Linearversion,options.Turbulence); % Spatial discretization
